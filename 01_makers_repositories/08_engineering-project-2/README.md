...
* [MERN](https://github.com/makersacademy/acebook-mern-template)
...
3. **Set up your project and card board.**  
   ...
   4. Ask one person to duplicate the Trello board template:
        * [This one if you're an Academy student](https://trello.com/b/ZX0SU3nr/acebook-meta).
        * [This one if you're an Apprentice](https://trello.com/b/TENPp7H2/acebook-meta-for-apprenticeships).
